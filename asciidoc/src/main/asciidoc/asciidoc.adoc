...
| HAS_HEADER        | <<:Asciidoc:Row>>         | 0..n        | References the tables header rows.
| HAS_BODY          | <<:Asciidoc:Row>>         | 0..n        | References the tables body rows.
| HAS_FOOTER        | <<:Asciidoc:Row>>         | 0..n        | References the tables footer rows.
