...
public class FindBugsScannerPluginTest {
	private FindBugsScannerPlugin plugin = new FindBugsScannerPlugin();
	...
	public void spotbugs() throws Exception {
		...
		final BugCollectionType bugCollectionType = plugin.unmarshalFindBugsXml(input);
