...
| HAS_PACKAGES      | <<:Jacoco:Package>>   | 0..n        | A Java package containing the Java classes for which the test coverage were recorded.
|====
...
|====
| Name              | Target label(s)       | Cardinality | Description
| HAS_COUNTERS      | <<:Jacoco:Counter>>   | 0..n        | The test coverage results: missed and covered lines and branches.
|====
...
|====
| Name              | Target label(s)       | Cardinality | Description
| HAS_METHODS       | <<:Jacoco:Method>>    | 0..n        | A Java method for which the test coverage were recorded.
|====
...
|====
| Name              | Target label(s)       | Cardinality | Description
| HAS_CLASSES       | <<:Jacoco:Class>>     | 0..n        | A Java class for which the test coverage were recorded.
|====
