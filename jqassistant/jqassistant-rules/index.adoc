...
[[default]]
[role=group,includesConstraints="debug:rule(info),spotbugs:MaxSpotBugsWarnings,checkstyle:*",includesConcepts="structure:MarkAsciidocTypeRegex, structure:LabelTypesMatchedByRegex"]
- <<debug:rule>>
