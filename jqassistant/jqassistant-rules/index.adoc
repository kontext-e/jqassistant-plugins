...
[[default]]
[role=group,includesConstraints="debug:rule(info),spotbugs:MaxSpotBugsWarnings",includesConcepts="structure:MarkAsciidocTypeRegex, structure:LabelTypesMatchedByRegex"]
- <<debug:rule>>
